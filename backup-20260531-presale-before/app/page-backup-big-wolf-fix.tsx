...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#020403] text-white overflow-x-hidden">
      <div className="fixed inset-0 pointer-events-none bg-[radial-gradient(circle_at_50%_0%,rgba(140,255,0,.20),transparent_35%),radial-gradient(circle_at_80%_20%,rgba(0,255,170,.10),transparent_28%)]" />

      <header className="relative z-20 border-b border-lime-400/20 bg-black/70 backdrop-blur-xl">
        <div className="max-w-[1500px] mx-auto px-5 py-5 flex items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-full border border-lime-400 bg-lime-400/10 flex items-center justify-center shadow-[0_0_25px_rgba(163,230,53,.5)] overflow-hidden">
              <img src="/awf_neon_wolf.png" alt="Alpha Wolf" className="w-10 h-10 object-contain" />
            </div>
            <div>
      ...
      <section className="relative z-10 max-w-[1500px] mx-auto px-5 py-10 grid xl:grid-cols-[1.1fr_.55fr] gap-6">
        <div className="rounded-3xl border border-lime-400/20 bg-black/50 p-6 md:p-9 shadow-[0_0_60px_rgba(132,255,0,.12)]">
          <div className="grid lg:grid-cols-[.95fr_1fr] gap-8 items-center">
            <div>
              ...
              <h1 className="text-5xl md:text-6xl xl:text-7xl font-black leading-[.95]">
                ALPHA
                <br />
                WOLF
                <br />
              ...
              <p className="text-xl md:text-2xl mt-8 text-gray-200 leading-relaxed max-w-[620px]">
            ...
            <div className="rounded-3xl border border-lime-400/20 bg-[radial-gradient(circle_at_50%_45%,rgba(132,255,0,.28),transparent_55%)] p-5 md:p-7 overflow-hidden">
              <div className="relative rounded-3xl border border-lime-400/25 min-h-[520px] flex items-center justify-center bg-black/25 overflow-hidden">
                <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(132,255,0,.07)_1px,transparent_1px),linear-gradient(rgba(132,255,0,.07)_1px,transparent_1px)] bg-[size:54px_54px]" />

                <img
                  src="/awf_neon_wolf.png"
                  alt="Alpha Wolf"
                  className="relative z-10 w-[360px] md:w-[480px] lg:w-[560px] max-w-[92%] object-contain drop-shadow-[0_0_65px_rgba(132,255,0,.78)]"
                />
              </div>

              <div className="mt-5 rounded-2xl border border-emerald-400/50 bg-black/80 p-5 shadow-[0_0_35px_rgba(16,185,129,.18)]">
                ...
                <p className="text-sm mt-3 text-gray-200">
                  Welcome! I’m Alpha, your AI assistant for the AWF ecosystem.
                </p>

                <div className="grid md:grid-cols-3 gap-3 mt-4">
                  {["What is AWF?", "AI Factory", "GPU Network"].map((q) => (
                    <button key={q} className="border border-lime-400/40 rounded-lg px-3 py-2 text-left text-xs text-lime-300 hover:bg-lime-400/10 transition">
                      {q}
                    </button>
                  ))}
                </div>
        ...
        <aside className="rounded-3xl border border-lime-400/30 bg-black/75 p-7 shadow-[0_0_50px_rgba(132,255,0,.15)]">
          <div className="flex justify-between items-center gap-4">
            <h2 className="text-3xl md:text-4xl font-black text-lime-400">AWF PRESALE</h2>
