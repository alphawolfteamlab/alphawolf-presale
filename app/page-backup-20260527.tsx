      ...
      <section className="relative z-10 max-w-[1500px] mx-auto px-5 py-10 grid xl:grid-cols-[1.2fr_.55fr] gap-6">
        <div className="rounded-3xl border border-lime-400/20 bg-black/45 p-6 md:p-10 shadow-[0_0_60px_rgba(132,255,0,.12)]">
          <div className="grid lg:grid-cols-[1fr_.9fr] gap-8 items-center">
            ...
            <div className="relative min-h-[480px] rounded-3xl border border-lime-400/20 bg-[radial-gradient(circle,rgba(132,255,0,.25),transparent_55%)] flex items-center justify-center overflow-hidden">
              ...
              <div className="relative text-[180px] md:text-[250px] drop-shadow-[0_0_45px_rgba(132,255,0,.8)]">
                🐺
              </div>

              <div className="absolute right-5 bottom-5 w-[300px] rounded-2xl border border-emerald-400/60 bg-black/80 p-5 backdrop-blur">
